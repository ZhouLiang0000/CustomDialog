...
public class TestDownDialog extends BaseDialog {
    ...
    public static TestDownDialog getInstance(){
        TestDownDialog dialog = new TestDownDialog();
        return dialog;
    }
    ...
    protected DialogOptions initDialogOptions() {
        return DialogOptions.popdownDialogOptions();
    }
